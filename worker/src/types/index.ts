...
// AI-generated test report summary (ScoutQA-style)
...
export interface TestIssue {
  ...
  affects: string           // What component/feature is affected
...
export interface TestReportSummary {
  ...
  // AI Narrative
  narrative: string         // "I have completed comprehensive testing..."
  ...
  // Testing methodology
  methodology: string[]     // List of what was tested
...
export interface LLMAction {
  action: 'click' | 'type' | 'scroll' | 'navigate' | 'wait' | 'assert' | 'complete' | 'setViewport' | 'setDevice' | 'setOrientation' | 'upload'
  target?: string
  selector?: string
  value?: string
  description: string
...
// Execution status indicates what happened during step execution
export type ExecutionStatus = 'EXECUTED' | 'BLOCKED' | 'EXECUTION_FAILED' | 'SKIPPED'

// Severity is evaluation of the observed state, NOT control flow
export type StepSeverity = 'GREEN' | 'YELLOW' | 'RED'
...
export interface TestStep {
  ...
  screenshotUrl?: string
  domSnapshot?: string
  // New structured output fields (primary outcome)
  execution_status?: ExecutionStatus  // What happened during execution
  observed_state?: Record<string, any>  // What was observed
  severity?: StepSeverity  // Evaluation of the observation
